...
//        listView = (ListView) findViewById(R.id.listview); //리스트뷰 객체
//        //어댑터객체 생성
//        adapter = new ArrayAdapter<String>(this,
//                android.R.layout.simple_list_item_1,
//                //보여질레이아웃형태
//                list//list 보여질데이터를 담고있는 배열
//        );//리스트뷰와 리스트를 연결하기 위해 사용되는 어댑터
//        listView.setAdapter(adapter);//리스트뷰의 어댑터를 지정해준다.
